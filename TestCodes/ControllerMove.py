...
# time.sleep(sleep)
# rtn = robot.MoveCart(desc_pos=start_point[1], tool=0, user=0, blendT=blendT)
# time.sleep(sleep)
# rtn = robot.MoveCart(desc_pos=start_point[2], tool=0, user=0, blendT=blendT)
# time.sleep(sleep)
# rtn = robot.MoveCart(desc_pos=start_point[0], tool=0, user=0, blendT=blendT)
# time.sleep(sleep)
i = 0
