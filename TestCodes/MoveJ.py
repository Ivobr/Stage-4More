...
robot.MoveJ(joint_pos=joint_pos[1], tool=tool, blendT=blendT, vel=vel, user=user)
robot.MoveGripper(2, 78, 100, 8, 10000, 0, 0, 0, 0, 0)
robot.MoveJ(joint_pos=joint_pos[3], tool=tool, blendT=blendT, vel=vel, user=user)
robot.MoveJ(joint_pos=joint_pos[2], tool=tool, blendT=blendT, vel=vel, user=user)
robot.MoveJ(joint_pos=joint_pos[0], tool=tool, blendT=blendT, vel=vel, user=user)
robot.MoveGripper(2, 0, 100, 8, 10000, 0, 0, 0, 0, 0)
robot.MoveJ(joint_pos=joint_pos[2], tool=tool, blendT=blendT, vel=vel, user=user)
print(rtn)
